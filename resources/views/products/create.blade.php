                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">                                                                         
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="kategori" class="form-control" placeholder="" name="kategori" value="{{ old('kategori') }}">
                                        @error('kategori')
                                        <div class="text-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-12">                                                                         
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="harga_beli" class="form-control" placeholder="" name="harga_beli" value="{{ old('harga_beli') }}">
                                        @error('harga_beli')
                                        <div class="text-danger mt-2">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-12">                                                                         
                                    <div class="form-group">
                                        <label for="helperText"><h6>Harga Jual</h6></label>
