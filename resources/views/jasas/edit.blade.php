...
<div id="main w-full">  
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                 <form action="{{ route('jasas.update', $jasa->id) }}" method="post">
                    @csrf
                    @method('PUT')
                    <div class="card">
                        <div class="d-flex">
                        ...
                        <div class="card-header">
                            <h4 class="card-title">Perbarui Jasa</h4>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">                                                                         
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="nama" class="form-control" placeholder="" name="nama" value="{{ old('nama', $jasa->nama) }}">
                                        @error('nama')
                                ...
                                <div class="col-md-12">                                                                         
                                    <div class="form-group">
                                        ...
                                        <input type="number" id="harga" class="form-control" placeholder="" name="harga" value="{{ old('harga', $jasa->harga) }}">
                                        @error('harga')
                                        <div class="text-danger mt-2">
                                            {{ $message }}
                                        </div>
