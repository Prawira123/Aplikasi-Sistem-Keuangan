                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-12">                                                                         
                                    <div class="form-group">
                                        <label for="helperText"><h6>Confirm Password</h6></label>
                                        <input type="password" id="password" class="form-control" placeholder="" name="password_confirmation">
