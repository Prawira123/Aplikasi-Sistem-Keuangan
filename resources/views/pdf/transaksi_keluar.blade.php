...
@if($transaksiKeluar['data'] && count($transaksiKeluar['data']) > 0)
...
<table>
    ...
    <tbody>
        ...
        <tr class="total-row">
            <td colspan="5" class="text-center">Total Transaksi Keluar</td>
            <td class="text-right">Rp.{{ number_format($transaksiKeluar['total'], 2, ',', '.') }}</td>
        </tr>
    </tbody>
</table>
